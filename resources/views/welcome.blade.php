            ...
            @foreach (DB::table('products')->get() as $prod)
                ...
                <div class="col-4">
                    <div class="card border-success mb-3" style="max-width: 18rem;">
                        <div class="card-header bg-transparent border-success">{{ $prod->category }}</div>
                        <div class="card-body text-success">
                            <h4 class="card-title">{{ $prod->name }}</h4>
                            <h6 class="card-title">Stock: {{ $prod->stock }}</h6>

                        </div>
                        <div class="card-footer bg-transparent border-success">Cost: ${{ $prod->price }}
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3">
                ...
                <p class="lead">An example 2-level sidebar with collasible menu items. The menu functions like an
